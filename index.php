...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid px-0 mb-5">
      <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active carousel-item-fullscreen">
              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-lg-10 text-start">
                    <p
                      class="fs-5 fw-medium text-secondary text-uppercase animated slideInRight"
                    >
                      Your Trusted Partner
                    </p>
                    <h1 class="display-1 text-white mb-5 animated slideInRight">
                      Premium Building Tools & Equipment Warehouse
                    </h1>
                    <a
                      href=""
          ...
          <div class="carousel-item carousel-item-fullscreen">
              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-lg-10 text-start">
                    ...
                    <h1 class="display-1 text-white mb-5 animated slideInRight">
                      Professional-Grade Tools For Every Project
                    </h1>
                    <a
                      href=""
                      class="btn btn-primary py-3 px-5 animated slideInRight"
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
            ...
            <h1 class="display-6 mb-4">
              No 1 distributor of Natraj spanners and files across Africa
            </h1>
            <p class="mb-4">
              We specialize in providing high-quality building tools and
              equipment for professionals and DIY enthusiasts. With a vast
              inventory and a commitment to excellence, we ensure you have the
              right tools for every project.
            </p>
            <div class="d-flex align-items-center mb-4">
              <div class="flex-shrink-0 bg-primary p-4">
                <!-- <h1 class="display-2 text-white">Premium</h1> -->
              ...
              <div class="ms-4">
                <p>
                  <i class="fa fa-check text-primary me-2"></i>Extensive
                  Inventory
                </p>
                <p>
                  <i class="fa fa-check text-primary me-2"></i>Top-Quality Tools
                </p>
                <p>
                ...
                <p class="mb-0">
                  <i class="fa fa-check text-primary me-2"></i>Fast Delivery
                </p>
              </div>
            </div>
            <div class="row pt-2">
        ...
        <div class="row g-5 align-items-center">
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            ...
            <h1 class="display-5 mb-4">
              Top Reasons to Rely on Our Tools & Services
            </h1>
            <p class="mb-4">
              We provide high-quality tools and equipment, ensuring reliability
              and efficiency for all your building projects. Our commitment to
              customer satisfaction and extensive inventory sets us apart.
            </p>
            <div class="row gy-4">
              <div class="col-12">
                <div class="d-flex">
    ...
    <div class="container-xxl py-5">
      <div class="container">
        ...
        >
          ...
          <h1 class="display-5 mb-4">
            Comprehensive Building Tools & Warehouse Solutions
          </h1>
        </div>
              ...
              <div class="service-detail">
                ...
                <div class="service-text">
                  <p class="text-white mb-0">
                    Rent high-quality tools for your projects at affordable
                    rates.
                  </p>
                </div>
              </div>
          ...
          <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item">
              ...
              <div class="service-detail">
                ...
                <div class="service-text">
                  <p class="text-white mb-0">
                    Secure and spacious storage solutions for your tools and
                    equipment.
                  </p>
                </div>
              </div>
          ...
          <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
            <div class="service-item">
              ...
              <div class="service-detail">
                ...
                <div class="service-text">
                  <p class="text-white mb-0">
                    Get personalized tool kits tailored to your specific needs.
                  </p>
                </div>
              </div>
              <a class="btn btn-light" href="">Learn More</a>
    ...
    <!-- section-distributor Start -->
    <div class="container-fluid section-distributor">
      <div class="text-container mx-auto wow fadeIn" data-wow-delay="0.1s">
        <h1 class="display-5 text-white mb-5 text-center pb-5">
          No 1 distributor of Natraj spanners and files across Africa
        </h1>
      </div>
    </div>
    <!-- section-distributor End -->
    ...
    <div class="container-fluid copyright bg-dark py-4">
      <div class="container text-center">
        <p class="mb-2">
          Copyright &copy; <a class="fw-semi-bold" href="https://alltsnetwork.com/"> All tech systems & co</a>,
          All Right Reserved.
        </p>
